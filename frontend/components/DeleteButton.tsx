...
import { BACKGROUND_COLOR, PRIMARY_COLOR, RED_COLOR, SECONDARY_COLOR, SHADOW_COLOR } from "../config/colors.config";
...
type IDeleteModal = FC<{ setModal: (value: boolean) => void, onDelete: () => void }>;
