...
const getNotes = async (database: WebDatabase): Promise<readonly Note[]> => {
...
const deleteNote = async (database: WebDatabase, id: string): Promise<void> =>
	deleteContentRow(database, "notes", "NOTE", id);
